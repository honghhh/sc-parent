...
<div class="layui-fluid" >
	<div class="layui-row layui-col-space15">
		<div class="layui-col-sm12 layui-input-inline" style="padding-top: 10px;">
			...
			<input type="hidden" id="page" name="current" value="${pageInfo.current}" />
			...
			<span>当前第<span id="nowpage">${pageInfo.current}</span>页[共<span id="totalnum">${pageInfo.total}</span>条,
